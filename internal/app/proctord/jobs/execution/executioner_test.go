...
type ExecutionerTestSuite struct {
	...
	mockSecretsStore  *jobSecrets.MockStore
...
func (suite *ExecutionerTestSuite) SetupTest() {
	...
	suite.mockSecretsStore = &jobSecrets.MockStore{}
...
func (suite *ExecutionerTestSuite) TestJobExecutionOnImageLookupFailure() {
	...
	suite.mockMetadataStore.On("GetJobMetadata", mock.Anything).Return(&modelMetadata.Metadata{}, errors.New("image-fetch-error")).Once()
